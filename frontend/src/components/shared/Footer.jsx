    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">Kaushal</h3>
            <p className="text-gray-400">Connecting skilled professionals with customers since 2024.</p>
          </div>
          <div>
          ...
          <div>
            ...
            <div className="mt-4">
              <a href="mailto:contact@skillmatch.com" className="flex items-center text-gray-400 hover:text-white transition-colors">
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} Kaushal. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
